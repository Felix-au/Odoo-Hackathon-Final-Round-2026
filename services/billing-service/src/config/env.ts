...
const envSchema = z.object({
  ...
  BILLING_DATABASE_URL: z.string().default('postgresql://dealflow:dealflow_dev@localhost:5436/billing_db'),
...
if (!parsed.success) {
  console.error('❌ Billing Service: Invalid environment configuration:');
