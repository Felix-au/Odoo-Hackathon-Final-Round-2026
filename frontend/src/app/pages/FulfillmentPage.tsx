  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-[#121214] border border-[#27272A] rounded-2xl p-6 space-y-4 relative overflow-hidden">
      ...
      <div className="bg-[#121214] border border-[#27272A] rounded-2xl p-5 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl text-xs font-semibold bg-[#1F1F23] hover:bg-[#27272A] text-slate-200 border border-[#27272A] flex items-center gap-1.5 transition-colors"
          >
